...
export const FETCH_SIMILAR_MOVIES_PENDING = 'FETCH_SIMILAR_MOVIES_PENDING';
export const FETCH_SIMILAR_MOVIES_FULFILLED = 'FETCH_SIMILAR_MOVIES_FULFILLED';
export const FETCH_SIMILAR_MOVIES_REJECTED = 'FETCH_SIMILAR_MOVIES_REJECTED';

export const FETCH_SIMILAR_SHOWS = 'FETCH_SIMILAR_SHOWS';
export const FETCH_SIMILAR_SHOWS_PENDING = 'FETCH_SIMILAR_SHOWS_PENDING';
export const FETCH_SIMILAR_SHOWS_FULFILLED = 'FETCH_SIMILAR_SHOWS_FULFILLED';
export const FETCH_SIMILAR_SHOWS_REJECTED = 'FETCH_SIMILAR_SHOWS_REJECTED';
